...
namespace fractions
{
    ...
    public class ScalePattern
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            if (!(obj is ScalePattern other)) return false;
            return Equals(other);
        }

        protected bool Equals(ScalePattern other)
        {
            return string.Equals(Name, other.Name) && Ascent.SequenceEqual(other.Ascent);
        }
        ...
        public static bool AscentIsValid(int[] ascent)
        {
