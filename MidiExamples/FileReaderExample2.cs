...
namespace midieval.examples
{
    ...
    /// </remarks>
    internal class FileReaderExample2 : ExampleBase
    {
        public FileReaderExample2() : base("FileReader2 - BWV0999: Prelude in Cm for Lute") { }

        public override void Run()
        {
            var outputDevice = midieval.OutputDevice.InstalledDevices.FirstOrDefault();
