...
namespace fractions.examples
{
    ...
    /// </remarks>
    internal class bach_js_bwv1067_orchestral_suite_2_in_bm_5_polonaise_double : ExampleBase
    {
        #region Constructors

        public bach_js_bwv1067_orchestral_suite_2_in_bm_5_polonaise_double() : base(nameof(bach_js_bwv1067_orchestral_suite_2_in_bm_5_polonaise_double)) { }
        ...
        private void Goahead(int seed)
        {
            ...
            foreach (var ef in efs)
            {
                ...
                var ppoints = Interpolator.InOutCurve(0.10, 0.90, sIn, sOut, ef.easeIn, ef.easeOut);
                var vpoints = Interpolator.InOutCurve(0.70, 0.90, sIn, sOut, ef.easeIn, ef.easeOut);
